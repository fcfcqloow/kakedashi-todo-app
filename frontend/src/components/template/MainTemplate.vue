  ...
  <v-layout class="height100">
    ...
    <v-navigation-drawer v-model="drawer" temporary>
      <v-list nav>
        ...
        <v-list-item prepend-icon="mdi-console" title="Log" value="Log" @click="$router.push('/log')" />
        <v-list-item disabled prepend-icon="mdi-backup-restore" title="Backup" value="Backup" @click="" />
